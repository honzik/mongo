...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { meter_id: @measure.meter_id, pozn: @measure.pozn, state: @measure.state, when: @measure.when }
    end
  ...
  test "should update measure" do
    put :update, id: @measure, measure: { meter_id: @measure.meter_id, pozn: @measure.pozn, state: @measure.state, when: @measure.when }
    assert_redirected_to measure_path(assigns(:measure))
  end
